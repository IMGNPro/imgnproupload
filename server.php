...
switch ($command) {
    case 'createmultipartupload': {
			...
			$url = "https://s3.amazonaws.com/".BUCKET_NAME.$file."?uploads&".
 ...
 //url: `https://${S3_BUCKET_NAME}.s3.amazonaws.com/${fileName}`
    ...
    case 'signuploadpart': {
		...
		for($part=1;$part<=$numParts;$part++) {
			...
			$url = "https://s3.amazonaws.com/".BUCKET_NAME.$file."?". http_build_query(array("partNumber"=>$part, "uploadId"=>$upId, "Signature"=>$upload_sig, "Expires"=>$exp, "AWSAccessKeyId"=>AWS_KEY));
		...
		$aborturl = "https://s3.amazonaws.com/".BUCKET_NAME.$file."?". http_build_query(array("uploadId"=>$upId, "Signature"=>$upload_sig, "Expires"=>$exp, "AWSAccessKeyId"=>AWS_KEY));
		...
		$completeurl = "https://s3.amazonaws.com/".BUCKET_NAME.$file."?". http_build_query(array("uploadId"=>$upId, "Signature"=>$upload_sig, "Expires"=>$exp, "AWSAccessKeyId"=>AWS_KEY));
